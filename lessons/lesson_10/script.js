...
// Вывели в консоль глобальный объект document в виде hml тегов (более читаемый вид html структуры)
// * console.log(document);

// Вывели document в виде объекта со всеми вложенными свойствами (более строгий вид html структуры)
// * console.dir(document)

//завели переменную h1 и положили в нее результат поиска через querySelector
// тега h1 передав аргументом в скобках имя тега
...
// применяем функции слушателя по клику к найденной кнопке
